...
Où avez-vous trouvé les données? Cette question évalue si l'ensemble de données est stocké de manière centralisée ou sur plusieurs sites Web et sous-pages. La question de la publication des données est importante pour résoudre le problème de la recherche de données. Dites-nous les différents sites Web, ainsi que les sous-pages d'un site Web (le cas échéant) où vous avez trouvé des caractéristiques de jeu de données uniques. Si vous trouvez les mêmes informations sur plusieurs sites et sous-pages, ne documentez que ceux qui vous permettent de répondre aux questions suivantes avec "Oui".
